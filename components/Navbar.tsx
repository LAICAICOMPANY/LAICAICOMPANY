    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-12 text-white">
          <a href="#" onClick={(e) => handleNavClick(e, '#')} className="text-5xl md:text-8xl font-bold tracking-tighter hover:text-white/50 transition-colors">
            HOME
          </a>
          {navLinks.map((link) => (
            <a
              ...
              className="text-5xl md:text-8xl font-bold tracking-tighter uppercase hover:text-white/50 transition-colors"
            >
              {link.name}
            </a>
          ))}
